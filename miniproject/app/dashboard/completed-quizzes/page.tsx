    ...
    <div className="min-h-screen" style={{ background: '#0B0E17' }}>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                <Link
                  href="/dashboard"
                  className="mr-4 p-2 bg-slate-100 border border-slate-300 rounded-lg text-text-secondary hover:text-text-primary hover:border-secondary transition-all"
                >
                  <ArrowLeft size={20} />
                </Link>
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold text-text-primary flex items-center">
                    <Brain size={36} className="mr-3 text-secondary" />
                    Completed Quizzes
                  </h1>
              ...
              <Link
                href="/quiz"
                className="px-6 py-3 bg-gradient-to-r from-secondary to-warning text-black rounded-lg font-semibold hover:scale-105 transition-transform hover:shadow-lg hover:shadow-secondary/25"
              >
                Take New Quiz
              </Link>
            </div>
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        {quizResults.length === 0 && !error ? (
          ...
          >
            <div className="bg-white-900/50 to-black/50 backdrop-blur-xl rounded-2xl border border-border p-12 max-w-2xl mx-auto">
              <Brain size={80} className="mx-auto mb-6 text-secondary opacity-50" />
              ...
              <Link
                href="/quiz"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-secondary to-warning text-black rounded-lg font-semibold hover:scale-105 transition-transform hover:shadow-lg hover:shadow-secondary/25"
              >
            ...
            {quizResults.map((quiz, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-xl rounded-2xl border border-border p-6 hover:border-slate-300 transition-all duration-300 group"
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center">
                      <div className="p-3 rounded-xl bg-gradient-to-r from-secondary to-blue-500 bg-opacity-20 mr-4">
                        <Brain size={24} className="text-secondary" />
                      </div>
                      <div>
                        <h3 className="text-xl font-semibold text-text-primary group-hover:text-secondary transition-colors">
                          Career Assessment
                        </h3>
                    ...
                    <div className="text-right">
                      ...
                      <div className={`px-3 py-1 rounded-full text-xs font-semibold ${badge.color} text-text-primary`}>
                        {badge.text}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {/* Career Path */}
                    <div className="bg-slate-100/30 rounded-lg p-4">
                      <h4 className="text-warning font-semibold mb-2 flex items-center">
                        <Award size={16} className="mr-2" />
                        Recommended Career Path
                      </h4>
                      <p className="text-text-primary text-lg font-medium">{quiz.career_path}</p>
                    </div>

                    {/* Interests */}
                    {quiz.interests && quiz.interests.length > 0 && (
                      <div>
                        <h4 className="text-text-secondary font-semibold mb-2 text-sm">Identified Interests</h4>
                        <div className="flex flex-wrap gap-2">
                          ...
                          {quiz.interests.length > 4 && (
                            <span className="px-3 py-1 bg-slate-200 text-text-secondary text-xs rounded-full">
                    ...
                    {quiz.skills && quiz.skills.length > 0 && (
                      <div>
                        <h4 className="text-text-secondary font-semibold mb-2 text-sm">Identified Skills</h4>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-slate-300">
                      <button
                        ...
                        className="text-secondary hover:text-text-primary text-sm font-medium transition-colors flex items-center"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-slate-200 hover:bg-slate-100-600 text-text-primary text-sm rounded-lg transition-colors"
                      >
                        Retake Quiz
                      </button>
                    </div>
        ...
        {quizResults.length > 0 && (
          <motion.div
            ...
            className="mt-12 bg-gradient-to-r from-gray-900/50 to-black/50 backdrop-blur-xl rounded-2xl border border-border p-8"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600">High Scores (80%+)</div>
              </div>
            </div>
          </motion.div>
        )}
