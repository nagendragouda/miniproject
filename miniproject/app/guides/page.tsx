...
const GuidesPage = () => {
  ...
  const popularTopics = [
    { name: 'Tech Careers', count: 45, color: 'bg-secondary/20 text-secondary' },
    { name: 'Interview Prep', count: 38, color: 'bg-warning/20 text-warning' },
    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-[#030712] text-white">
          ...
          <div className="text-center">
            ...
            >
              <div className="flex items-center space-x-3 px-6 py-3 glass-card rounded-full">
                ...
                <span className="text-secondary font-semibold">Career Guidance</span>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              Popular <span className="text-secondary">Topics</span>
            </h2>
          </motion.div>
          ...
          >
            <div className="flex flex-col lg:flex-row gap-6 items-center">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-text-primary font-semibold">Filter Guides:</span>
              </div>
                ...
                <div className="flex-1">
                  ...
                  >
                    {difficulties.map(difficulty => (
                      <option key={difficulty} value={difficulty} className="bg-background">{difficulty}</option>
                    ))}
                  </select>
                </div>
              </div>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              Featured <span className="text-warning">Guides</span>
            </h2>
          </motion.div>
                ...
                >
                  <div className="bg-gradient-to-r from-secondary to-warning p-1">
                    <div className="bg-background p-2">
                      <div className="text-center text-text-primary font-semibold text-sm">Featured Guide</div>
                    </div>
                  </div>
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-text-secondary text-sm mb-6 leading-relaxed">{guide.description}</p>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {guide.topics.slice(0, 2).map((topic, topicIndex) => (
                        <span key={topicIndex} className="px-3 py-1 glass-card rounded-full text-xs text-secondary">
                          {topic}
                        </span>
                      ))}
                      {guide.topics.length > 2 && (
                        <span className="px-3 py-1 glass-card rounded-full text-xs text-slate-600">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-full px-6 py-4 bg-gradient-to-r from-secondary to-warning rounded-lg text-space-dark font-bold transition-all duration-300 hover:shadow-lg hover:shadow-secondary/25 flex items-center justify-center space-x-2"
                    >
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              All <span className="text-secondary">Guides</span>
            </h2>
          </motion.div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-8">
                    <div className="flex-1">
                      <div className="flex items-start space-x-4 mb-4">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-4 mb-2 text-sm text-slate-600">
                          ...
                          <p className="text-text-secondary leading-relaxed mb-4">{guide.description}</p>
                    ...
                    <div className="flex flex-col justify-center">
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 bg-gradient-to-r from-secondary to-warning rounded-lg text-space-dark font-bold transition-all duration-300 hover:shadow-lg hover:shadow-secondary/25 flex items-center space-x-2"
                      >
                        <span>Read Guide</span>
                        <ArrowRight className="h-5 w-5" />
                      </motion.button>
          ...
          {filteredGuides.length === 0 && (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-text-primary mb-4">No guides found</h3>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Compass className="h-16 w-16 text-warning mx-auto mb-6" />
            <h2 className="text-4xl font-bold text-text-primary mb-6">
