    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-[#030712] text-white">
          ...
          <div className="text-center">
            ...
            >
              <div className="flex items-center space-x-3 px-6 py-3 glass-card rounded-full">
                ...
                <span className="text-secondary font-semibold">Press & Media</span>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <h2 className="text-4xl font-bold text-text-primary mb-8">
                About <span className="text-secondary">CareerGuide</span>
              </h2>
            ...
            >
              <div className="glass-card p-8 rounded-2xl">
                <h3 className="text-2xl font-bold text-text-primary mb-6">Key Facts</h3>
                ...
                <div className="mt-8 pt-6 border-t border-glass-border">
                  <h4 className="text-text-primary font-semibold mb-4">Media Contact</h4>
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <Mail className="h-4 w-4 text-secondary" />
                      <span className="text-text-secondary">sudanva7@gmail.com</span>
                      <button
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-text-secondary">Phone: +91 7204686919</span>
                      <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              Recent <span className="text-warning">Press Releases</span>
            </h2>
          </motion.div>
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  <div className="flex-1">
                    ...
                    <h3 className="text-2xl font-bold text-text-primary mb-4">{release.title}</h3>
                    <p className="text-text-secondary leading-relaxed">{release.summary}</p>
                  </div>
                  <motion.a
                    href={release.link}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-3 glass-card rounded-lg text-text-primary hover:bg-white/10 transition-colors flex items-center space-x-2"
                  >
                    <span>Read More</span>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              Media <span className="text-secondary">Assets</span>
            </h2>
          ...
          <div className="space-y-12">
            {mediaAssets.map((category, categoryIndex) => (
              ...
              >
                <h3 className="text-2xl font-bold text-text-primary mb-6 flex items-center space-x-3">
                  {category.category === 'Logos' && <ImageIcon className="h-6 w-6 text-secondary" />}
                  {category.category === 'Screenshots' && <ImageIcon className="h-6 w-6 text-warning" />}
                  ...
                  {category.items.map((asset, assetIndex) => (
                    <div key={assetIndex} className="glass-card p-6 rounded-lg hover:bg-white/5 transition-colors">
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <h4 className="text-text-primary font-semibold mb-1">{asset.name}</h4>
                          <span className="text-slate-600 text-sm">{asset.type} • {asset.size}</span>
                        </div>
                        <motion.button
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              Awards & <span className="text-warning">Recognition</span>
            </h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {awards.map((award, index) => (
              ...
              >
                <Award className="h-12 w-12 text-warning mx-auto mb-6" />
                <div className="text-2xl font-bold text-secondary mb-2">{award.year}</div>
                <h3 className="text-xl font-bold text-text-primary mb-4">{award.title}</h3>
                <p className="text-text-secondary text-sm mb-4">{award.organization}</p>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Mail className="h-16 w-16 text-secondary mx-auto mb-6" />
            <h2 className="text-4xl font-bold text-text-primary mb-6">
              Media Inquiries
            </h2>
