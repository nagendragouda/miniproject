    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0B0E17] via-[#1a1b3e] to-[#0B0E17] py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          {/* Billing Toggle */}
          <div className="inline-flex items-center bg-slate-100/50 backdrop-blur-sm rounded-xl p-1">
            <button
            ...
            >
              Quarterly
              <span className="absolute -top-2 -right-2 bg-gradient-to-r from-warning to-primary text-text-primary text-xs px-2 py-1 rounded-full">
                Save 25%
              </span>
            </button>
          </div>
          ...
          {plans.map((plan, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative bg-white-900/50 to-black/50 backdrop-blur-xl rounded-3xl border-2 p-8 ${
                  plan.popular 
                    ? 'border-secondary shadow-lg shadow-secondary/25 scale-105' 
                    : 'border-border hover:border-slate-300'
                } transition-all duration-300`}
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r from-secondary to-primary px-4 py-2 rounded-full">
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-xl font-semibold transition-all duration-300 ${
                    plan.popular
                      ? 'bg-gradient-to-r from-secondary to-primary text-black hover:shadow-lg hover:scale-105'
                      : 'bg-white/10 text-text-primary hover:bg-white/20 border border-slate-300'
                  }`}
                >
                  Get Started
                </button>
