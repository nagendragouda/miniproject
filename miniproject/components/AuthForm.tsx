...
const AuthForm: React.FC<AuthFormProps> = ({ mode, onSubmit, isLoading, error }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-warning/10 rounded-full blur-3xl"></div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-black/20 border border-gray-600 rounded-lg text-text-primary placeholder-gray-400 focus:border-secondary focus:ring-1 focus:ring-secondary/50 transition-all"
                    required
                  />
                </motion.div>
                <motion.div
            ...
            >
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 bg-black/20 border border-gray-600 rounded-lg text-text-primary placeholder-gray-400 focus:border-secondary focus:ring-1 focus:ring-secondary/50 transition-all"
                required
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-600 hover:text-text-primary transition-colors"
              >
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-gradient-to-r from-secondary to-warning rounded-lg text-space-dark font-bold text-lg transition-all duration-300 hover:shadow-lg hover:shadow-secondary/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
          ...
          >
            <p className="text-slate-600 text-sm">
              ...
              <a 
                ...
                className="text-secondary hover:text-warning transition-colors font-semibold"
              >
