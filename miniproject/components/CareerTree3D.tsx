      ...
      <div className="absolute bottom-4 left-4 bg-black/20 backdrop-blur-sm rounded-lg p-4">
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-text-primary">Main Career</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-full bg-warning"></div>
            <span className="text-xs text-text-primary">Related Careers</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-full bg-primary"></div>
            <span className="text-xs text-text-primary">Required Skills</span>
          </div>
        </div>
      </div>
