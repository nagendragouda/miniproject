  ...
  return (
    <div className="fixed bottom-4 right-4 z-[200]">
      <button
        ...
        className="bg-red-600 text-text-primary px-3 py-2 rounded-lg text-xs font-mono hover:bg-red-700 transition-colors"
      >
        Debug {isVisible ? '📱' : '🔍'}
      </button>
      ...
      {isVisible && (
        <div className="absolute bottom-12 right-0 w-80 max-h-96 bg-black/90 border border-gray-600 rounded-lg p-4 font-mono text-xs overflow-auto">
          ...
          <div className="mt-4">
            ...
            <div className="max-h-32 overflow-auto text-text-secondary">
              {logs.map((log, i) => (
