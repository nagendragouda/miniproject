  ...
  return (
    <div className="glass-card p-6 rounded-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-text-primary">Development Setup</h2>
          <p className="text-sm text-slate-600">Configure Supabase authentication for development</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-4 bg-black/20 rounded-lg border border-gray-600">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-text-primary">Create Test User</p>
              <p className="text-sm text-slate-600">Creates a confirmed user for testing</p>
            </div>
          </div>
          <button
            onClick={handleCreateDevUser}
            disabled={isCreatingUser}
            className="px-4 py-2 bg-secondary text-space-dark rounded-lg font-medium hover:bg-warning transition-colors disabled:opacity-50"
          >
        ...
        <button
          ...
          className="w-full p-4 bg-black/20 rounded-lg border border-gray-600 text-left hover:border-secondary transition-colors"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Disable email confirmation in Supabase</p>
              </div>
            </div>
        ...
        {showInstructions && (
          ...
          >
            <h4 className="font-medium text-text-primary mb-3">{instructions.title}</h4>
            ...
            <div className="p-3 bg-secondary/10 rounded border border-secondary/30">
              <p className="text-sm font-medium text-secondary mb-2">Test Credentials:</p>
