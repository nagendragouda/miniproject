...
export default function RoadmapVisualization({ 
  ...
  return (
    <div className="w-full h-full relative bg-background/50 rounded-xl border border-border overflow-hidden">
      {/* Progress Bar */}
      <div className="absolute top-0 left-0 right-0 z-10 p-4 bg-gradient-to-b from-space-dark/90 to-transparent">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-lg font-semibold text-text-primary">{roadmap.title}</h3>
      ...
      <AnimatePresence>
        {selectedNode && (
          ...
          >
            <motion.div
              className="bg-background border border-slate-300 rounded-xl p-6 max-w-md w-full mx-4 max-h-[80vh] overflow-y-auto"
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-text-primary">{selectedNode.title}</h3>
              ...
              {/* Description */}
              <p className="text-text-secondary mb-4">{selectedNode.description}</p>

              {/* Skills */}
              {selectedNode.skills.length > 0 && (
                <div className="mb-4">
                  <h4 className="text-sm font-medium text-text-primary mb-2">Skills Learned</h4>
              ...
              {selectedNode.resources.length > 0 && (
                <div className="mb-4">
                  <h4 className="text-sm font-medium text-text-primary mb-2">Resources</h4>
              ...
              {editable && (
                <div className="border-t border-slate-300 pt-4">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-sm font-medium text-text-primary">Mark as Complete</span>
                    <button
                  ...
                  <div>
                    ...
                    {editingNotes ? (
                      <textarea
                        ...
                        className="w-full h-20 bg-slate-100 border border-gray-600 rounded-lg px-3 py-2 text-text-primary text-sm resize-none focus:outline-none focus:border-secondary"
                      />
                    ) : (
                      <div className="text-sm text-slate-600 min-h-[2rem]">
      ...
      <div className="absolute bottom-4 right-4 z-10 flex flex-col space-y-2">
        <button
          ...
          className="w-10 h-10 bg-slate-100 border border-gray-600 rounded-lg flex items-center justify-center text-text-primary hover:bg-slate-200 transition-colors"
        >
        ...
        <button
          ...
          className="px-3 py-1 bg-slate-100 border border-gray-600 rounded-lg text-xs text-text-primary hover:bg-slate-200 transition-colors"
        >
          Reset
        </button>
      </div>
