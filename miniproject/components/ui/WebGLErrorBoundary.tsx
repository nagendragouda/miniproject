...
export default class WebGLErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        this.props.fallback || (
          <div className="w-full h-full flex items-center justify-center bg-slate-50/50 rounded-xl border border-slate-300">
            <div className="text-center p-6">
              ...
              <h3 className="text-lg font-medium text-text-primary mb-2">3D View Unavailable</h3>
              ...
              <button 
                ...
                className="mt-3 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-text-primary text-sm rounded-lg transition-colors"
              >
                Refresh Page
              </button>
            </div>
